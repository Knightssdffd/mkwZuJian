package com.example.aksy.imoocbusiness.imgeloader;
...
import com.example.aksy.imoocbusiness.R;
...
public class ImageLoaderManager {
     ...
     * 默认参数值
     */
    private static final int THREAD_COUNT = 4;//标明最多UIL可以有多少线程
    private static final int PROPRITY = 2;//标明我们的图片加载的一个优先级
    ...
    private ImageLoaderManager(Context context) {
        ImageLoaderConfiguration configuration = new ImageLoaderConfiguration
                ...
                .denyCacheImageMultipleSizesInMemory()//防止缓存多tao尺寸的图片到我们的内存中
